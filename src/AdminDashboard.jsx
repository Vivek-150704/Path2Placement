...
function AnalyticsCharts({ results, loading }) {
  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} key="score-chart">
      ...
      <Grid item xs={12} key="branch-chart">
        <Paper elevation={4} sx={{ p: 3, borderRadius: '12px' }}>
      ...
      <Grid item xs={12} key="school-chart">
        <Paper elevation={4} sx={{ p: 3, borderRadius: '12px' }}>
      ...
      <Grid item xs={12} key="year-chart">
        <Paper elevation={4} sx={{ p: 3, borderRadius: '12px' }}>
...
function ResultsTable({ results, loading }) {
  ...
  // --- CSV Headers updated (Team Name removed) ---
  const csvHeaders = [
    { label: "Name", key: "name" },
    { label: "USN", key: "usn" },
